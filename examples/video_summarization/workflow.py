...
if __name__ == "__main__":
    ...
    print(f"[bold] Transcription Classification: {transcription.classification.classification} [/bold]")

    print(f"[bold] Summarization of transcription [/bold]")
    if transcription.classification.classification == "job-interview":
        summary = runner.graph_outputs(g.name, ingested_object_id=content_id, extractor_name=summarize_job_interview.name)
        print(summary)
    elif transcription.classification.classification == "sales-call":
        summary = runner.graph_outputs(g.name, ingested_object_id=content_id, extractor_name=summarize_sales_call.name)
        print(summary)
